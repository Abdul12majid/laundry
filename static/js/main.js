...
const washingPrice = document.getElementById("washing").value;
const ironingPrice = document.getElementById("ironing").value;
let previewNumber = 1;
let receiptDatabase = [];
let inputValue = "";
...
function updateTotalPrice() {
  ...
  if (washingCheckbox.checked) {
    totalPrice += parseInt(washingPrice);
  }

  if (ironingCheckbox.checked) {
    totalPrice += parseInt(ironingPrice);
  }
